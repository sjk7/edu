...
protected:
    ...
    */
    void *GetNextI(__inout POSITION& rp) const;


    /* Return a pointer to the object at p
       Asking for the object at NULL will return NULL harmlessly.
    */
    void *GetI(__in_opt POSITION p) const;
    void *GetValidI(__in POSITION p) const;
...
public:
    ...
    */
protected:
    POSITION FindI( __in void * pObj) const;
    ...
    */
    void *RemoveI(__in_opt POSITION p);
    ...
    */
    POSITION AddTailI(__in void * pObj);
public:
    ...
    */
protected:
    POSITION AddHeadI(__in void * pObj);
public:
    ...
    */
protected:
    POSITION AddAfterI(__in_opt POSITION p, __in void * pObj);
public:
    ...
    */
    protected:
    POSITION AddBeforeI(__in_opt POSITION p, __in void * pObj);
    public:
...
public:
    ...
    OBJECT *GetNext(__inout POSITION& rp) const { return (OBJECT *) GetNextI(rp); }

    OBJECT *Get(__in_opt POSITION p) const { return (OBJECT *) GetI(p); }
    OBJECT *GetValid(__in POSITION p) const { return (OBJECT *) GetValidI(p); }
    ...
    OBJECT *Remove(__in_opt POSITION p) { return (OBJECT *) RemoveI(p); }
    POSITION AddBefore(__in_opt POSITION p, __in OBJECT * pObj) { return AddBeforeI(p, pObj); }
    ...
    POSITION Find( __in OBJECT * pObj) const { return FindI(pObj); }
}; // end of class declaration
