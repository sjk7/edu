...
*/
void *CBaseList::GetNextI(__inout POSITION& rp) const
{
...
*/
void *CBaseList::GetI(__in_opt POSITION p) const
{
    if (p == NULL) {
        return NULL;
    }
...
void *CBaseList::GetValidI(__in POSITION p) const
{
    CNode * pn = (CNode *) p;
    void *pObject = pn->GetData();
    // ASSERT(pObject != NULL);    // NULL pointers in the list are allowed.
...
*/
POSITION CBaseList::FindI( __in void * pObj) const
{
    POSITION pn;
...
*/
void *CBaseList::RemoveI(__in_opt POSITION pos)
{
...
POSITION CBaseList::AddTailI(__in void *pObject)
{
    /* Lock the critical section before continuing */
...
*/
POSITION CBaseList::AddHeadI(__in void *pObject)
{
    CNode *pNode;
    // ASSERT(pObject);  // NULL pointers in the list are allowed.
...
*/
POSITION  CBaseList::AddAfterI(__in_opt POSITION pos, __in void * pObj)
{
    if (pos==NULL)
...
*/
POSITION CBaseList::AddBeforeI(__in_opt POSITION pos, __in void * pObj)
{
    if (pos==NULL)
        return AddTailI(pObj);
